package org.jeecg.modules.land.supportingfacilities.entity;
 ...
 * @Version: V1.0
 *
 * <p>表 {@code t_supporting_facilities}（市政配套项目）。
 * 该表由旧库 {@code xj_kjkfb_supporting_facilities} 迁移而来，业务字段保持兼容，
 * 新项目统一使用 {@code t_} 表命名规范。
 *
...
public class SupportingFacilities implements Serializable {
